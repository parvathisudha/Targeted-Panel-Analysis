...
${CNVKIT}/cnvkit.py coverage ${Tumor_bam} ${BEDFILES_DIR}/All.bed -o ${CNVKIT_DIR}${Tumor_ID}/${Tumor_bam}"_Sample.targetcoverage.cnn"
${CNVKIT}/cnvkit.py coverage ${Normal_bam} ${BEDFILES_DIR}/All.bed -o ${CNVKIT_DIR}${Tumor_ID}/${Normal_bam}"_Sample.targetcoverage.cnn"
