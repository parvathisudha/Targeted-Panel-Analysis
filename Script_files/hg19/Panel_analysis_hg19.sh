...
#HSMetrics
cd ${HOME_DIR}
java -jar picard-2.10.0_picard.jar CollectHsMetrics I=${Tumor_bam} O=${HSMETRICS_DIR}"Mutation_"${Tumor_ID}"_hs_metrics.txt" R=${REF} BAIT_INTERVALS=${BEDFILES_DIR}/Mutation_list.interval_list TARGET_INTERVALS=${BEDFILES_DIR}/Mutation_list.interval_list PER_TARGET_COVERAGE=${HSMETRICS_DIR}"Mut_"${Tumor_ID}".txt" COVMAX=1500
java -jar picard-2.10.0_picard.jar CollectHsMetrics I=${Tumor_bam} O=${HSMETRICS_DIR}"Translocations_"${Tumor_ID}"_hs_metrics.txt" R=${REF} BAIT_INTERVALS=${BEDFILES_DIR}/Translocation_list.interval_list TARGET_INTERVALS=${BEDFILES_DIR}/Translocation_list.interval_list PER_TARGET_COVERAGE=${HSMETRICS_DIR}"Trans_"${Tumor_ID}".txt" COVMAX=1500
java -jar picard-2.10.0_picard.jar CollectHsMetrics I=${Normal_bam} O=${HSMETRICS_DIR}"Mutation_"${Normal_ID}"_hs_metrics.txt" R=${REF} BAIT_INTERVALS=${BEDFILES_DIR}/Mutation_list.interval_list TARGET_INTERVALS=${BEDFILES_DIR}/Mutation_list.interval_list PER_TARGET_COVERAGE=${HSMETRICS_DIR}"Mut_"${Normal_ID}".txt" COVMAX=1500
java -jar picard-2.10.0_picard.jar CollectHsMetrics I=${Normal_bam} O=${HSMETRICS_DIR}"Translocations_"${Normal_ID}"_hs_metrics.txt" R=${REF} BAIT_INTERVALS=${BEDFILES_DIR}/Translocation_list.interval_list TARGET_INTERVALS=${BEDFILES_DIR}/Translocation_list.interval_list PER_TARGET_COVERAGE=${HSMETRICS_DIR}"Trans_"${Normal_ID}".txt" COVMAX=1500
java -jar picard-2.10.0_picard.jar CollectHsMetrics I=${Tumor_bam} O=${HSMETRICS_DIR}"All_"${Tumor_ID}"_hs_metrics.txt" R=${REF} BAIT_INTERVALS=${BEDFILES_DIR}/All_list.interval_list TARGET_INTERVALS=${BEDFILES_DIR}/All_list.interval_list PER_TARGET_COVERAGE=${HSMETRICS_DIR}"All_"${Tumor_ID}".txt" COVMAX=1500
java -jar picard-2.10.0_picard.jar CollectHsMetrics I=${Normal_bam} O=${HSMETRICS_DIR}"All_"${Normal_ID}"_hs_metrics.txt" R=${REF} BAIT_INTERVALS=${BEDFILES_DIR}/All_list.interval_list TARGET_INTERVALS=${BEDFILES_DIR}/All_list.interval_list PER_TARGET_COVERAGE=${HSMETRICS_DIR}"All_"${Normal_ID}".txt" COVMAX=1500
